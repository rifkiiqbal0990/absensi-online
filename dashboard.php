<?php
    ...
    $siswas = getsiswas();
    $totaldatasiswa = count(getsiswas());

    $kehadirans = getkehadiran();
    $totaldatakehadiran = count(getkehadiran());
?>
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    ...
                                    <div class="stat-digit"> <i class=""></i><?= $totaldatasiswa ?></div>
                                </div>
                                <div class="progress">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="card">
                            <div class="stat-widget-two card-body">
                                <div class="stat-content">
                                    <div class="stat-text">Absensi Kehadiran</div>
                                    <div class="stat-digit"> <i class=""></i><?= $totaldatakehadiran ?></div>
                                </div>
                                <div class="progress">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Laporan Absensi Siswa</h4>
                            </div>
                            <div class="card-body">
