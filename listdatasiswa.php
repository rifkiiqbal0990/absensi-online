            ...
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                 ...
                 ?>
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                                class="icon icon-app-store"></i><span class="nav-text">Halaman Siswa</span></a>
                        <ul aria-expanded="false">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                        <?php foreach ($siswas as $dashboard => $siswa) { ?>
                                                <tr>
                                                    <td><?= $dashboard + 1 ?></td>
                                                    <td><?= htmlspecialchars($siswa['tgl_absensi']) ?></td>
                                                    <td><?= htmlspecialchars($siswa['nama']) ?></td>
                                                    <td><?= htmlspecialchars($siswa['kelas']) ?></td>
                                                    <td>
                                                        <a href="profilsiswa.php?id=<?=$siswa['id']?>" class="btn btn-primary text-white"><i class="bi bi-eye-fill"></i></a> |
                                                        <a href="editsiswa.php?id=<?=$siswa['id']?>" class="btn btn-warning text-white"><i class="bi bi-pencil-fill"></i></a> |
                                                        <a onClick="return confirm('apakah anda yakin ingin menghapus data tersebut?')" href="delete.php?id=<?=$siswa['id']?>" class="btn btn-danger text-"><i class="bi bi-trash3"></i></a>
                                                    </td>
                                                </tr>           
                                            <?php } ?>
                                        </tbody>
