<?php
    ...
    if (isset($_POST['tambah'])) {
        if (isiKehadiran($_POST) > 0) {
            ...
            document.location.href='isikehadiran.php';
            </script>";
        }
    }
?>
...
<head>
    ...
    <title>Isi Kehadiran Siswa</title>
    <!-- Favicon icon -->
                                ...
                                <form action="" method="POST">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            ...
                                            <input type="datetime-local" name="waktu_masuk" class="form-control" aria-label="Masukan waktu_masuk" aria-describedby="addon-wrapping">
                                        </div>
                                        <div class="col-sm-4">
                                            <label>waktu keluar</label>
                                            <input type="datetime-local" name="waktu_keluar" class="form-control" aria-label="Masukan waktu_keluar" aria-describedby="addon-wrapping">
                                        </div>
                                        <div class="col-sm-4 mb-3 mb-sm-0">
                                            <label>Deskripsi kerja harian</label>  
                                            <textarea class="form-control" name="deskripsi_kerja_harian" placeholder="Deskripsi kerja harian" id="floatingTextarea2" style="height: 100px"></textarea>
                                        </div>
                                        </div>
